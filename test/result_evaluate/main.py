...
if __name__ == '__main__':
    first_file_name = "normal_md_doppler_mdad/rsize1_rsearch2_contral10_num5/md"
    second_file_name = "normal_md_doppler_mdad/rsize1_rsearch2_contral10_num5/md_other"
    big_data = False
